...
def add_lm_to_texts(texts, labels, class_label, n, seed=28, num_labels = 10):
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_path", type=str, default = "saved_models_bias_impact/cfar10_dataset_model_vit_base.pth", help = "path of saved model")
